...
@NgModule({
  ...
  declarations: [ AppComponent, HelloComponent, RsidebarComponent, EncabezadoComponent, FooterComponent, AdministracionComponent, CalculosComponent, ConsultasComponent, PlanReduccionComponent ],
